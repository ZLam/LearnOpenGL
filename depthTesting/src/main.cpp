...
bool bDepthTesting = false;
int nDepthTestingType = 0;      //0：非线性测试，1：线性测试
...
int main()
{
    ...
    Shader shader_axis =Shader("/Users/lam/Desktop/Workspace/TestGL/depthTesting/res/vertex_axis.vs", "/Users/lam/Desktop/Workspace/TestGL/depthTesting/res/fragment_axis.fs");
    Shader shader_bg = Shader("/Users/lam/Desktop/Workspace/TestGL/depthTesting/res/vertex_bg.vs", "/Users/lam/Desktop/Workspace/TestGL/depthTesting/res/fragment_bg.fs");
    Shader shader_lighting = Shader("/Users/lam/Desktop/Workspace/TestGL/depthTesting/res/vertex_lighting.vs", "/Users/lam/Desktop/Workspace/TestGL/depthTesting/res/fragment_lighting.fs");
    Shader shader_cube = Shader("/Users/lam/Desktop/Workspace/TestGL/depthTesting/res/vertex_cube.vs", "/Users/lam/Desktop/Workspace/TestGL/depthTesting/res/fragment_cube.fs");
    Shader shader_model = Shader("/Users/lam/Desktop/Workspace/TestGL/depthTesting/res/vertex_model.vs", "/Users/lam/Desktop/Workspace/TestGL/depthTesting/res/fragment_model.fs");
    Shader shader_depth = Shader("/Users/lam/Desktop/Workspace/TestGL/depthTesting/res/vertex_depth.vs", "/Users/lam/Desktop/Workspace/TestGL/depthTesting/res/fragment_depth.fs");
    
    if (shader_axis.getId() == -1 || shader_bg.getId() == -1 || shader_lighting.getId() == -1 || shader_cube.getId() == -1 || shader_model.getId() == -1 || shader_depth.getId() == -1)
	{
		glfwTerminate();
		return -1;
	}
    ...
    auto pTexture_cube_diffuse = TextureMgr::getInstance()->addTexture("/Users/lam/Desktop/Workspace/TestGL/depthTesting/res/container2.png", Texture_Type::Diffuse);
    auto pTexture_cube_specular = TextureMgr::getInstance()->addTexture("/Users/lam/Desktop/Workspace/TestGL/depthTesting/res/container2_specular.png", Texture_Type::Specular);
    ...
    Model model = Model("/Users/lam/Desktop/Workspace/TestGL/depthTesting/res/nanosuit/nanosuit.obj");
    ...
    shader_depth.use();
    shader_depth.uniform1f("near", camera->getNear());
    shader_depth.uniform1f("far", camera->getFar());
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        shader_depth.use();
        shader_depth.uniform1i("testingType", nDepthTestingType);
        ...
        {
            shader_depth.use();
            shader_depth.uniformMatrix4fv("model", mat4_model_bg);
            shader_depth.uniformMatrix4fv("view", mat4_view);
            shader_depth.uniformMatrix4fv("projection", mat4_projection);
            glBindVertexArray(vao_bg);
            glDrawArrays(GL_TRIANGLES, 0, sizeof(verticesData_bg) / (sizeof(float) * 9));
            glBindVertexArray(0);
        }
        ...
        else
        {
            ...
            for (int i = 0; i < cubeNum; i++)
            {
                ...
                mat4_rotate_cube = glm::rotate(mat4_rotate_cube, (float)glfwGetTime() + cubeRadiansArr[i] + 100, glm::vec3(0.0f, 0.0f, 1.0f));
                glm::mat4 mat4_model_cube = mat4_translate_cube * mat4_rotate_cube;
                shader_depth.uniformMatrix4fv("model", mat4_model_cube);
                glDrawArrays(GL_TRIANGLES, 0, sizeof(verticesData_cube) / (sizeof(float) * 9));
            }
            glBindVertexArray(0);
        }
...
//    stbi_set_flip_vertically_on_load(true);
    ...
    auto camera = CameraMgr::getInstance()->add("main", glm::vec3(0.0f, 0.0f, 5.0f), glm::vec3(0.0f, 0.0f, -1.0f), glm::vec3(0.0f, 1.0f, 0.0));
    camera->setNear(1.0f);
...
void callback_keyboard(GLFWwindow* window, int key, int scancode, int action, int mods)
{
    ...
    else if (action == GLFW_RELEASE)
    {
        ...
        {
            nDepthTestingType = nDepthTestingType == 0 ? 1 : 0;
        }
